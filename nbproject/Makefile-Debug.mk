...
${OBJECTDIR}/ASTAssignmentNode.o: ASTAssignmentNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ASTAssignmentNode.o ASTAssignmentNode.cpp
...
${OBJECTDIR}/ASTIfNode.o: ASTIfNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ASTIfNode.o ASTIfNode.cpp

${OBJECTDIR}/ASTLiteralNode.o: ASTLiteralNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ASTLiteralNode.o ASTLiteralNode.cpp

${OBJECTDIR}/ASTLoopNode.o: ASTLoopNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ASTLoopNode.o ASTLoopNode.cpp

${OBJECTDIR}/ASTMarkerNode.o: ASTMarkerNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ASTMarkerNode.o ASTMarkerNode.cpp
...
${OBJECTDIR}/ASTVariableDeclarationNode.o: ASTVariableDeclarationNode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ASTVariableDeclarationNode.o ASTVariableDeclarationNode.cpp
...
${OBJECTDIR}/EncounteredError.o: EncounteredError.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EncounteredError.o EncounteredError.cpp
...
${OBJECTDIR}/QuadrupleGenerator.o: QuadrupleGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/QuadrupleGenerator.o QuadrupleGenerator.cpp
...
${OBJECTDIR}/SemanticAnalyzer.o: SemanticAnalyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SemanticAnalyzer.o SemanticAnalyzer.cpp

${OBJECTDIR}/SyncSetBuilder.o: SyncSetBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncSetBuilder.o SyncSetBuilder.cpp
